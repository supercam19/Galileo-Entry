  ...
  en: {
    ...
    instruments: {
      ...
      charts: {
          ...
          chart6Body: 'Altitude below 1 bar (km) recorded throughout the probe’s descent into Jupiter’s atmosphere.',
          timeAxis: 'Time (s)',
          altitudeAxis: 'Altitude below 1 bar (km)',
  ...
  fr: {
    ...
    instruments: {
      ...
      charts: {
        ...
        timeAxis: 'Temps (s)',
        altitudeAxis: 'Altitude sous 1 bar (km)',
